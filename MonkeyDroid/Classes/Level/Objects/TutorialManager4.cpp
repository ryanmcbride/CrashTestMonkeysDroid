...
TutorialManager4::TutorialManager4(Track *track, CCNode *backLayer, b2World* world, b2Vec2 *startPos):
...
TutorialManager4::~TutorialManager4()
{
	if(m_created)
	{
...
void TutorialManager4::CreateSelf()
{
	if(m_created) return;
	m_State = 0;
}
void TutorialManager4::Update(float xpos,float ypos)
{
...
void TutorialManager4::DestroySelf()
{
	if(m_created)
	{
    }
