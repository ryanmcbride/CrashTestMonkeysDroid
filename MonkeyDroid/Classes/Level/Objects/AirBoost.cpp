...
AirBoost::AirBoost(b2World *world, CCNode *ccLayer, b2Vec2 *startPos, float rotation):
...
void AirBoost::Update(float xpos,float ypos)
{
...
bool AirBoost::HandleBeginContact(b2Fixture *fixtureA,b2Fixture *fixtureB)
{
