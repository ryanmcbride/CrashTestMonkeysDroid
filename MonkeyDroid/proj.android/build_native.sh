...
NDK_ROOT="/users/administrator/Development/android-ndk-r7b"
...
COCOS2DX_ROOT="/users/administrator/Desktop/cocos2d/cocos2d-2.1beta3-x-2.1.1"
APP_ROOT="$DIR/.."
